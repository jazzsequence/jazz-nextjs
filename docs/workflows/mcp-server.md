...
**Config Location**: `~/.config/claude/mcp.json` (global, shared across all projects)
...
1. Check `~/.config/claude/mcp.json` has jazzsequence-wordpress in global `mcpServers`
