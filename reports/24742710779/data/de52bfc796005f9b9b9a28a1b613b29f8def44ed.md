...
- Name: comments.spec.ts >> Comment Section >> should display "Leave a Reply" form
      ...
      - generic [ref=e141]:
        ...
        - generic [ref=e146]:
          ...
          - link "wordpress" [ref=e152] [cursor=pointer]:
            - /url: /tag/wordpress
    - region "3 Comments" [ref=e153]:
      - generic [ref=e154]:
        - heading "3 Comments" [level=2] [ref=e155]
        - generic [ref=e157]:
          - article [ref=e158]:
            - img "Matt" [ref=e159]
            - generic [ref=e160]:
              - generic [ref=e161]:
                - generic [ref=e162]: Matt
                - time [ref=e163]: November 3, 2025
              - generic [ref=e164]:
                - paragraph [ref=e165]: Hi Chris,
                - paragraph [ref=e166]:
                  - text: Thanks for writing an article about our article! I think it’s ok to agree that the Wapuu just isn’t for everyone. I have to say, I didn’t think this would start a tennis match. I never meant to upset anyone, either. I wrote a follow-up article if you’re curious about why we posted the original critique.
                  - link "https://www.afteractive.com/blog/wordpress-wapuu-defenders" [ref=e167] [cursor=pointer]:
                    - /url: https://www.afteractive.com/blog/wordpress-wapuu-defenders
          - generic [ref=e169]:
            - article [ref=e170]:
              - img "Chris Reynolds" [ref=e171]
              - generic [ref=e172]:
                - generic [ref=e173]:
                  - generic [ref=e174]: Chris Reynolds
                  - time [ref=e175]: November 3, 2025
                - generic [ref=e176]:
                  - paragraph [ref=e177]: What is the internet if not a place for debating things? 😂
                  - paragraph [ref=e178]: To be honest, I didn’t realize how passionate I could be about Wapuu before writing my post. What this dialogue has made me realize is that, there might be a lot of things wrong with the WordPress ecosystem right now, but (IMO 😁) Wapuu isn’t one of them.
                  - paragraph [ref=e179]:
                    - text: Thanks for stopping by and writing the original article!
                    - emphasis [ref=e180]: "AI generated image with using the prompt: can you generate an image of a WordPress wapuu and a “Weird Axolotal Bunny Guy” giving each other a high five?"
                    - text: 🤣
            - article [ref=e183]:
              - img "Matthew Hunt" [ref=e184]
              - generic [ref=e185]:
                - generic [ref=e186]:
                  - generic [ref=e187]: Matthew Hunt
                  - time [ref=e188]: November 5, 2025
                - paragraph [ref=e190]: The Wapuu and the WABG. I love it! I, too, had no idea that questioning the cuteness of the Wapuu would get any kind of reaction. It must hold more power in the community than I realized. Perhaps this is the start of its resurgence in the WordPress community. Thanks for giving the article some attention.
      - generic [ref=e192]:
        - heading "Leave a Reply" [level=3] [ref=e193]
        - paragraph [ref=e194]:
          - text: Fields marked *
          - generic [ref=e195]: with an asterisk
        ...
        - generic [ref=e202]:
          - generic [ref=e203]: Comment *
          - textbox "Comment" [ref=e204]
        - button "Post Comment" [ref=e205]
  - contentinfo [ref=e206]:
    - generic [ref=e207]:
      - generic [ref=e208]:
        - generic [ref=e210]:
          - paragraph [ref=e211]: jazzsequence
          - paragraph [ref=e212]: "@jazzsequence@jazzsequence.com"
          - paragraph [ref=e213]: I make websites and things.
          - generic [ref=e214]:
            - button "Follow on the Open Social Web" [ref=e215]:
              - generic [ref=e216]: 
              - text: Follow on the Open Social Web
            - link "View profile" [ref=e217] [cursor=pointer]:
              - /url: https://jazzsequence.com/@jazzsequence
        - paragraph [ref=e218]:
          - text: Want to know what makes this site go?
          - link "Check out the GitHub repo" [ref=e219] [cursor=pointer]:
            - /url: https://github.com/jazzsequence/jazz-nextjs
          - text: "!"
      - generic [ref=e220]:
        - link "Personal site" [ref=e221] [cursor=pointer]:
        ...
        - link "Newsletter" [ref=e223] [cursor=pointer]:
          ...
          - generic [ref=e224]: 
        - link "Bluesky" [ref=e225] [cursor=pointer]:
        ...
        - link "Instagram" [ref=e229] [cursor=pointer]:
          ...
          - generic [ref=e230]: 
        - link "Spotify" [ref=e231] [cursor=pointer]:
