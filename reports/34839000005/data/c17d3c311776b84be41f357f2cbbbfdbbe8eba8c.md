...
- Name: post-single.spec.ts >> Individual Post Page >> should display post date
- Location: tests/e2e/post-single.spec.ts:47:3
...
Call log:
  - Expect "toBeVisible" locator('time') with timeout 10000ms
  - waiting for locator('time')
...
- contentinfo:
  ...
  - text: "jazzsequence Last Built: 9/14/2026, 5:43:39 AM MT •"
  - link "1ff8f89":
