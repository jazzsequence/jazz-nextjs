...
- generic [active] [ref=f3e1]:
  ...
  - contentinfo [ref=f3e8]:
    - generic [ref=f3e10]:
      - generic [ref=f3e12]:
        - text: "Ray ID:"
        - code [ref=f3e13]: a3af24c1fe9cd571
      - generic [ref=f3e14]:
        - generic [ref=f3e15]:
          - text: Performance and Security by
          - link "Cloudflare, opens in a new tab" [ref=f3e16] [cursor=pointer]:
            - /url: https://www.cloudflare.com?utm_source=challenge&utm_campaign=m
            - text: Cloudflare
        - link "Privacy, opens in a new tab" [ref=f3e18] [cursor=pointer]:
