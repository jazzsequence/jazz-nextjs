...
When reviewing code for commit approval:

1. **Check for queued user messages FIRST**:
   - Look for any `<system-reminder>` tags indicating user sent messages while you were working
   - If there are queued messages:
     - **DO NOT APPROVE** - respond with: **"⚠️ PAUSED - User messages queued"**
